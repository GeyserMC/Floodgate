...
public class WhitelistCommand implements FloodgateCommand {
    ...
    public Command<UserAudience> buildCommand(CommandManager<UserAudience> commandManager) {
        Command.Builder<UserAudience> builder = commandManager
                .commandBuilder("fwhitelist", Description.of("Easy way to whitelist Bedrock players"))
                .permission(Permission.COMMAND_WHITELIST.get());

        commandManager.command(builder.literal("add", "a")
                .argument(ProfileAudience.ofAnyIdentifierBedrock("player"))
                .handler(context -> performCommand(context, true)));

        return builder.literal("remove", "r")
                .argument(ProfileAudience.ofAnyIdentifierBedrock("player"))
    ...
    public void performCommand(CommandContext<UserAudience> context, boolean add) {
        ...
        xboxClient.xuidByGamertag(name).whenComplete((result, error) -> {
            if (error != null) {
    ...
    public static final class Message {
        public static final TranslatableMessage INVALID_USERNAME =
                new TranslatableMessage("floodgate.command.fwhitelist.invalid_username", MessageType.ERROR);
        public static final TranslatableMessage API_UNAVAILABLE = new TranslatableMessage(
                "floodgate.command.fwhitelist.api_unavailable " + CommonCommandMessage.CHECK_CONSOLE,
                MessageType.ERROR);
        public static final TranslatableMessage ACCOUNT_NOT_FOUND =
                new TranslatableMessage("floodgate.command.fwhitelist.account_not_found", MessageType.ERROR);
        public static final TranslatableMessage PLAYER_ADDED =
                new TranslatableMessage("floodgate.command.fwhitelist.player_added", MessageType.SUCCESS);
        public static final TranslatableMessage PLAYER_REMOVED =
                new TranslatableMessage("floodgate.command.fwhitelist.player_removed", MessageType.SUCCESS);
        public static final TranslatableMessage PLAYER_ALREADY_WHITELISTED =
                new TranslatableMessage("floodgate.command.fwhitelist.player_already_whitelisted", MessageType.NORMAL);
        public static final TranslatableMessage PLAYER_NOT_WHITELISTED =
                new TranslatableMessage("floodgate.command.fwhitelist.player_not_whitelisted", MessageType.NORMAL);
    }
}
