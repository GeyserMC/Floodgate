...
dependencies {
    ...
    api("com.github.Konicai.bstats-metrics", "bstats-base", Versions.bstatsVersion) // todo: use official dependency once https://github.com/Bastian/bstats-metrics/pull/118 is merged
}
