...
package com.minekube.connect.util.backoff;
...
public class ExponentialBackOff implements BackOff {
     ...
     *
     * <p>A randomization factor of 0.5 results in a random period ranging between 50% below and
    ...
    public long nextBackOffMillis() throws IOException {
        ...
        int randomizedInterval =
                getRandomValueFromInterval(randomizationFactor, Math.random(),
    ...
    public static class Builder {
         ...
         * The randomization factor to use for creating a range around the retry interval.
         *
         * <p>A randomization factor of 0.5 results in a random period ranging between 50% below
         * and 50% above the retry interval.
         */
        ...
        /**
         * The maximum elapsed time in milliseconds after instantiating {@link ExponentialBackOff}
         * or calling {@link #reset()} after which {@link #nextBackOffMillis()} returns {@link
         * BackOff#STOP}.
         */
        ...
        /**
         * Returns the randomization factor to use for creating a range around the retry interval.
         * The default value is {@link #DEFAULT_RANDOMIZATION_FACTOR}.
         *
         * <p>A randomization factor of 0.5 results in a random period ranging between 50% below
         * and 50% above the retry interval.
         *
        ...
        /**
         * Returns the value to multiply the current interval with for each retry attempt. The
         * default value is {@link #DEFAULT_MULTIPLIER}.
         */
        public final double getMultiplier() {
            return multiplier;
        }
        ...
        /**
         * Returns the maximum value of the back off period in milliseconds. Once the current
         * interval reaches this value it stops increasing. The default value is {@link
         ...
         *
         * <p>If the time elapsed since an {@link ExponentialBackOff} instance is created goes past
         * the max_elapsed_time then the method {@link #nextBackOffMillis()} starts returning {@link
         * BackOff#STOP}. The elapsed time can be reset by calling {@link #reset()}.
         */
        public final int getMaxElapsedTimeMillis() {
            return maxElapsedTimeMillis;
